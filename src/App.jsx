...
const App = () => {
  ...
  //This function prevent form submit validates city and fetches data through api
        ...
        {!weather ? (
          ...
          <div className='mt-6 text-center transition-opacity duration-500'>
             ...
             <div className='flex justify-between items-center'> 
               ...
               className='bg-amber-700 hover:bg-amber-800 text-white font-semibold py-1
             ...
             alt={weather.weather[0].description} className='mx-auto my-4 animate-bounce'/>
